  ...
  return (
    <div>
      {loading ? (
        ...
        <>
          <div className=" errormsg flex flex-col items-center justify-center p-8 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 border border-blue-300 rounded-md text-center h-screen">
            <h2 className="text-2xl font-bold text-blue-700 mb-4">
              📱 Enhance Your Experience!
            </h2>
            <p className="text-lg text-gray-700 mb-4">
              It looks like you're using a smaller screen. For the best experience
              with smoother animations and better visual effects, try viewing this site on a larger screen more than 1200px.
            </p>
            <p className="text-md text-gray-600 mb-6">
              We’ve designed an immersive and interactive experience that is best enjoyed on bigger screens.
            </p>
          ...
          <div className=' iphone'>
            ...
            >
              <img
                className=' z-[1] w-[75.75rem] h-[35.25rem]'
                src={IphoneFrame}
                alt="IphoneFrame"
                style={{ position: 'relative' }}
              />
              <video
                className="absolute top-1/2 left-1/2 w-[68.75rem] h-[31.25rem] rounded-lg"
                style={{
                  // width: '1100px',
                  // height: '500px',
                ...
                muted={isMuted}
              />{
                isMuted ? (<button className="absolute bottom-64  z-[2] right-[16rem] " onClick={() => setIsMuted(false)}><img src={ofMic} alt='ofMic' /></button>)
                  : (<button className="absolute bottom-64 z-[2] right-[16rem] " onClick={() => setIsMuted(true)}><img src={onMic} alt='onMic' /></button>)
              }
            </div>
            ...
            <div className=' py-52'>
              ...
              <div className="relative flex items-center justify-center w-full mx-auto">
                ...
                <div
                  ...
                  ref={scrollerRef}
                >
                  <div className="flex-none relative w-[67.625rem] ml-56 h-auto rounded-[32px] border border-white border-opacity-30 overflow-hidden shadow-lg">
                  ...
                  <div className="flex-none relative w-[65.625rem] h-auto  rounded-[32px] border border-white border-opacity-30 overflow-hidden shadow-lg">
                  ...
                  <div className="flex-none relative w-[65.625rem] mr-56 h-auto  rounded-[32px] border border-white border-opacity-30 overflow-hidden shadow-lg"
        ...
        />
            ...
            <div >
              ...
              >
                ...
                />
                <video
                  className="absolute top-1/2 left-1/2 w-[68.75rem] h-[31.25rem] rounded-xl"
                  style={{
                    // width: '1100px',
                    // height: '500px',
                    transform: 'translate(-50%, -50%)',
                  ...
                  muted={isMuted2}
                />{
                  isMuted2 ? (<button className="absolute bottom-16  z-[2] right-[16rem] " onClick={() => setIsMuted2(false)}><img src={ofMic} alt='ofMic' /></button>)
                    : (<button className="absolute bottom-16 z-[2] right-[16rem] " onClick={() => setIsMuted2(true)}><img src={onMic} alt='onMic' /></button>)
                }
              </div>
            </div>
